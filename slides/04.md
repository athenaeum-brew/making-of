...
class Being {
    ...
    // So-called 'getters', i.e. methods to get attribute values for name and description
...
![Being Class](/images/1_humans-and-gods-naive.svg)
...
![Multiple Inheritance](/images/6_heroes-and-semigods-reduced.svg)
