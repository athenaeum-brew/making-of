...
### Key Features: Strong Typing vs. Weak Typing [⁽¹⁾](https://youtu.be/qJr1PjTt2S8?si=EEK31l38bzuP8Qsv)
...
<small>More details [here](/?/exercises/02.md).</small>
...
Primitive Data Types: Represent basic values and are directly supported by the Java language. Examples include int, double, boolean, char. They hold actual data values.
...
// bitwise 
int bitwise_or =  (num1 | num2); // 14: (1010 | 110) = 1110
// array
...
List<String> names = Stream.of("Berlioz", "Debussy", "Ravel", "Manoury").collect(Collectors.toList());
String third = names.get(2); // Ravel
```
